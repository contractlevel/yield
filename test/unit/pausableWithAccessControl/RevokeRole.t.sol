...
contract RevokeRoleTest is BaseTest {
    ...
    function test_yield_pausableWithAccessControlRebalancer_revokeRole_emitsRoleRevokedEvent() public {
        ...
        baseRebalancer.revokeRole(Roles.CONFIG_ADMIN_ROLE, config_admin); /// @dev revoke role from config_admin in BaseTest
        ...
        assertEq(emittedConfigAdmin, config_admin);
    ...
    function test_yield_pausableWithAccessControlYieldPeer_revokeRole_emitsRoleRevokedEvent() public {
        ...
        baseParentPeer.revokeRole(Roles.CONFIG_ADMIN_ROLE, config_admin); /// @dev revoke role from config_admin in BaseTest
    ...
    function test_yield_pausableWithAccessControlRebalancer_revokeRole_updatesRoleStorage() public {
        ...
        */
        ...
        assertEq(baseRebalancer.hasRole(Roles.CONFIG_ADMIN_ROLE, config_admin), false); /// ---------- @dev Check hasRole in _roles mapping updated
    ...
    function test_yield_pausableWithAccessControlYieldPeer_revokeRole_updatesRoleStorage() public {
        ...
        */
        ...
        assertEq(baseParentPeer.hasRole(Roles.CONFIG_ADMIN_ROLE, config_admin), false); /// ---------- @dev Check hasRole in _roles mapping updated
