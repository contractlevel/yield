...
contract MockUpgradeParentPeer is MockUpgradeStorage, ParentPeer {
    constructor(address reb, address reg, address r, address l, uint64 c, address u, address s)
        ParentPeer(reb, reg, r, l, c, u, s)
    {}
}

contract MockUpgradeChildPeer is MockUpgradeStorage, ChildPeer {
    constructor(address reg, address r, address l, uint64 c, address u, address s, uint64 p)
        ChildPeer(reg, r, l, c, u, s, p)
    {}
}
...
contract MockUpgradeRebalancer is MockUpgradeStorage, Rebalancer {
    constructor(address parent) Rebalancer(parent) {}
}
