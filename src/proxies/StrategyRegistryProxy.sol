...
/// @title StrategyRegistryProxy
/// @author Judge Finance
/// @notice This contract serves as a proxy for the YieldCoin Strategy Registry contracts.
/// @dev This contract implements an ERC1967 proxy that delegates calls to a logic contract.
contract StrategyRegistryProxy is ERC1967Proxy {
