...
library Roles {
    ...
    bytes32 public constant CONFIG_ADMIN_ROLE = 0xb92d52e77ebaa0cae5c23e882d85609efbcb44029214147dd132daf9ef1018af;
    ...
    bytes32 public constant CROSS_CHAIN_ADMIN_ROLE = 0xb28dc5efd345f3bec5c16749590c736fbb2ba9912d8680cac4da7a59f918a760;

    /// @notice Role for pausing and unpausing the system in case of emergency.
    // keccak256("EMERGENCY_PAUSER_ROLE");
    bytes32 public constant EMERGENCY_PAUSER_ROLE = 0x3b72b77b3d95d9b831cca52b36d7a9c3758f77be6c47ebd087c47739c743d369;
    // keccak256("EMERGENCY_UNPAUSER_ROLE");
    bytes32 public constant EMERGENCY_UNPAUSER_ROLE =
        0x7bd03e5eb4ee9007f85634e07fc4bb1fbe96d33e9f2d1644bc6bda2b6b8a3169;

    /// @notice Role for withdrawing fees from the system.
    /// - withdrawFees - (in modules/YieldFees.sol)
    // keccak256("FEE_WITHDRAWER_ROLE");
    bytes32 public constant FEE_WITHDRAWER_ROLE = 0xcecef922ac6ded813804bed2d5fdf033decf4a090fa3c9b9f529302a0aff6455;

    /// @notice Role for setting the protocol fee rate.
    /// - setFeeRate - (in modules/YieldFees.sol)
    // keccak256("FEE_RATE_SETTER_ROLE");
    bytes32 public constant FEE_RATE_SETTER_ROLE = 0x658e71518b7b5afc52c60427d525dee00a59b3720f918587414f669096f77bee;
}
