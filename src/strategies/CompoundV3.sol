...
/// @notice Strategy for Compound V3
contract CompoundV3 is YieldStrategy {
    /*//////////////////////////////////////////////////////////////
                               VARIABLES
    //////////////////////////////////////////////////////////////*/
    ...
    constructor(address yieldPeer, address comet) YieldStrategy(yieldPeer) {
        i_comet = comet;
    }
    ...
    /// @notice Gets the total value of the USDC in the Compound V3 pool
    /// @param usdc The USDC token address
    /// @return totalValue The total value of the USDC in the Compound V3 pool
