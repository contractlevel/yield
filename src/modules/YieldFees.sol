...
abstract contract YieldFees is AccessControlDefaultAdminRulesUpgradeable, IYieldFees {
    /*//////////////////////////////////////////////////////////////
                           TYPE DECLARATIONS
    //////////////////////////////////////////////////////////////*/
    ...
    // ERC-7201: keccak256(abi.encode(uint256(keccak256("yieldcoin.storage.YieldFees")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant YIELD_FEES_STORAGE_LOCATION =
        0x853571cb68111ee91d33df43d653890ed387a529557b80ade0723b14e4000b00;
